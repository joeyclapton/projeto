...
public class Teste {
        ...
        public static void main(String[] args) throws Exception {
            ...
            Disciplina desenvolvimentoSoftware = new Disciplina("Deselvolvimento de Softaware", 89, 8,
                ...
                Disciplina modular = new Disciplina("Modular", 45, 9, ClassificacaoDisciplina.OBRIGATORIA,curso1,caram);
                ...
                Disciplina computadoresSociedade = new Disciplina("Computadores e Sociedade", 144, 2,
                                ClassificacaoDisciplina.OBRIGATORIA,curso1,caram);
                Disciplina aed1 = new Disciplina("AED I", 6, 3, ClassificacaoDisciplina.OBRIGATORIA,curso1,caram);
            ...
            System.out.println(engenhariaRequisitos.alunos.size()); // verifica quantos alunos estão matriculados
                ...
                if(engenhariaRequisitos.estadoDisciplina()==false){
                     curso1.removerDisciplina(engenhariaRequisitos);  // remove disciplina que possui menos de 3 alunos
                }
            ...
            -- Melhorar realização matricula
            -- Criar sistema cobranças
            Após um aluno se inscrever para um semestre, o sistema de cobranças é notificado pelo sistema de matrículas, de modo que o aluno possa ser cobrado pelas disciplinas daquele semestre.

            -- Desenvolver e aplicar
            Em nenhum dos testes os usuários estão fazendo login primeiro
