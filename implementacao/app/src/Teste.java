...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        Disciplina desenvolvimentoSoftware = new Disciplina("Deselvolvimento de Softaware",89,8,ClassificacaoDisciplina.OBRIGATORIA);
        Disciplina modular = new Disciplina("Modular",45,9,ClassificacaoDisciplina.OPTATIVA);
        Disciplina inteligenciaArtificial = new Disciplina("Inteligência Artifical ",63,6,ClassificacaoDisciplina.OPTATIVA);
        Disciplina engenhariaRequisitos = new Disciplina("Engenharia Requisitos",9,25,ClassificacaoDisciplina.OPTATIVA);
        Disciplina computadoresSociedade = new Disciplina("Computadores e Sociedade",144,2,ClassificacaoDisciplina.OBRIGATORIA);
